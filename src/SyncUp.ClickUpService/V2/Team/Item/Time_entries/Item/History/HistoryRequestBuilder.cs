...
namespace SyncUp.ClickUp.Api.V2.Team.Item.Time_entries.Item.History
{
    ...
    public partial class HistoryRequestBuilder : BaseRequestBuilder
    {
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/team/{team_%2Did}/time_entries/{timer_id}/history", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SyncUp.ClickUp.Api.V2.Team.Item.Time_entries.Item.History.HistoryRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HistoryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/team/{team_%2Did}/time_entries/{timer_id}/history", rawUrl)
        {
        }
        /// <summary>
