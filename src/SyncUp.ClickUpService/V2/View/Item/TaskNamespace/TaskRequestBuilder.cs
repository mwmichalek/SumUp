...
namespace SyncUp.ClickUp.Api.V2.View.Item.TaskNamespace
{
    ...
    public partial class TaskRequestBuilder : BaseRequestBuilder
    {
        ...
        public TaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/view/{view_id}/task?page={page}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SyncUp.ClickUp.Api.V2.View.Item.TaskNamespace.TaskRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TaskRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/view/{view_id}/task?page={page}", rawUrl)
        {
        }
        /// <summary>
