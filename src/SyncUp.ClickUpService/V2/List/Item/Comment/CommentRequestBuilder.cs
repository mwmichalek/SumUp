...
namespace SyncUp.ClickUp.Api.V2.List.Item.Comment
{
    ...
    public partial class CommentRequestBuilder : BaseRequestBuilder
    {
        ...
        public CommentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/list/{list_id}/comment{?start*,start_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SyncUp.ClickUp.Api.V2.List.Item.Comment.CommentRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CommentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/list/{list_id}/comment{?start*,start_id*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
            /// <summary>Enter the `date` of a List info comment using Unix time in milliseconds.</summary>
            [QueryParameter("start")]
            public int? Start { get; set; }
            /// <summary>Enter the Comment `id` of a List info comment.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
