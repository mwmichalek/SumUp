...
namespace ClickUp.Api.V2.Folder.Item.View
{
    ...
    public partial class ViewRequestBuilder : BaseRequestBuilder
    {
        ...
        public ViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/folder/{folder_id}/view", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ClickUp.Api.V2.Folder.Item.View.ViewRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ViewRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/folder/{folder_id}/view", rawUrl)
        {
        }
        /// <summary>
